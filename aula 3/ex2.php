...
<head>
 ...
 h1, h2 { color: #333; }
 table { border-collapse: collapse; width: 100%; max-width: 600px; background: white; marginbottom: 20px;}
 th, td { border: 1px solid #ccc; padding: 8px; text-align: left; }
 th { background: #eee; }
 .verdadeiro { color: green; font-weight: bold; }
 .falso { color: red; font-weight: bold; }
 .vars { font-family: monospace; background: #efefef; padding: 10px; border-radius: 5px; marginbottom: 20px; }
 </style>
</head>
<body>
